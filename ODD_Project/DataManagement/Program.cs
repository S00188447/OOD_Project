    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            using (db)
            {
                ...
                Games G1 = new Games() { GameID = 1, GenID = 1, Genre = Genre1, Name = "Call", Cost = 60m, ReleaseDate = new DateTime(2019, 6, 6), Review = "good" };
                ...
                Games G2 = new Games() { GameID = 2, GenID = 2, Genre = Genre2, Name = "Call", Cost = 60m, ReleaseDate = new DateTime(2019, 6, 6), Review = "good" };
                ...
                Games G3 = new Games() { GameID = 3, GenID = 3, Genre = Genre3, Name = "Call", Cost = 60m, ReleaseDate = new DateTime(2019, 6, 6), Review = "good" };
