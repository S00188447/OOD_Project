    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            using (db)
            {
                ...
                Games G1 = new Games() { GameID = 1, GenID = 1, Genre = Genre1, Name = "Call of Duty", Cost = 60m, ReleaseDate = new DateTime(2011, 1, 2), Review = "6/10" };
                Games G2 = new Games() { GameID = 2, GenID = 1, Genre = Genre1, Name = "Bioshock", Cost = 30m, ReleaseDate = new DateTime(2012, 3, 6), Review = "8/10" };
                Games G3 = new Games() { GameID = 3, GenID = 1, Genre = Genre1, Name = "Gears of war", Cost = 30m, ReleaseDate = new DateTime(2013, 7, 5), Review = "8/10" };
                Games G4 = new Games() { GameID = 4, GenID = 1, Genre = Genre1, Name = "Wolfenstein", Cost = 40m, ReleaseDate = new DateTime(2015, 4, 9), Review = "7/10" };
                Games G5 = new Games() { GameID = 5, GenID = 1, Genre = Genre1, Name = "Overwatch", Cost = 60m, ReleaseDate = new DateTime(2012, 3, 2), Review = "7/10" };


                Genre Genre2 = new Genre() { GenID = 2, Name = "Sport" };
                Games G6 = new Games() { GameID = 6, GenID = 2, Genre = Genre2, Name = "NFHL", Cost = 40m, ReleaseDate = new DateTime(2015, 1, 12), Review = "6/10" };
                Games G7 = new Games() { GameID = 7, GenID = 2, Genre = Genre2, Name = "Fifa", Cost = 60m, ReleaseDate = new DateTime(2011, 9, 11), Review = "7/10" };
                Games G8 = new Games() { GameID = 8, GenID = 2, Genre = Genre2, Name = "NBA", Cost = 40m, ReleaseDate = new DateTime(2012, 12, 6), Review = "7/10" };
                Games G9 = new Games() { GameID = 9, GenID = 2, Genre = Genre2, Name = "Wii Sports", Cost = 20m, ReleaseDate = new DateTime(2013, 7, 6), Review = "9/10" };


                Genre Genre3 = new Genre() { GenID = 3, Name = "RPG" };
                Games G10 = new Games() { GameID = 10, GenID = 3, Genre = Genre3, Name = "Bloodborne", Cost = 60m, ReleaseDate = new DateTime(2019, 2, 1), Review = "9/10" };
                Games G11 = new Games() { GameID = 11, GenID = 3, Genre = Genre3, Name = "Dark Souls", Cost = 60m, ReleaseDate = new DateTime(2019, 8, 5), Review = "10/10" };
                Games G12 = new Games() { GameID = 12, GenID = 3, Genre = Genre3, Name = "Sekiro", Cost = 20m, ReleaseDate = new DateTime(2018, 11, 9), Review = "8/10" };
                Games G13 = new Games() { GameID = 13, GenID = 3, Genre = Genre3, Name = "Skyrim", Cost = 20m, ReleaseDate = new DateTime(2017, 3, 8), Review = "8/10" };
                Games G14 = new Games() { GameID = 14, GenID = 3, Genre = Genre3, Name = "Fable", Cost = 30m, ReleaseDate = new DateTime(2016, 7, 11), Review = "10/10" };
                Games G15 = new Games() { GameID = 15, GenID = 3, Genre = Genre3, Name = "Shadow of war", Cost = 40m, ReleaseDate = new DateTime(2016, 12, 6), Review = "9/10" };
